...
Array:   .float 1.0,   6.0,  8.0, 10.0, 12.0, 2.0
 ...
 # ColSum -  Sums up all the numbers in in a given column
 #Parameters:
 ...
 ColSum:
 	...
 	sll 	$t2, $a2, 2  #offset to item directly below in column
 ...
 LoopColumns:
 	...
 	# Check if ran through all the rows, if not retrieve value and add to accumalutor
 	# then increment to the next item in the column, increment counter
 	beq 	$t7, $a3, End
 	l.s 	$f1, ($a0)
 	add.s 	$f0, $f0, $f1
